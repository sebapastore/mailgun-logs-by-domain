                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr v-for="user in users.data">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <Link v-if="user.role === 'Comercial' || user.role === 'Cliente'" :href="route('user-customers.index', {user_id: user.id})" class="font-bold text-indigo-600 hover:text-indigo-900">Ver Clientes</Link>

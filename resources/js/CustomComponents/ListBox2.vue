        ...
        >
            <div v-show="open" class="absolute mt-1 w-full rounded-md bg-white shadow-lg" style="z-index: 9999;">
                <div class="relative pt-2 pb-1 pl-8 pr-4">
                    <input v-on:keyup="searchSelectOptions($event)" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm leading-4 text-sm p-1 w-full" ref="search" type="text">
                </div>
